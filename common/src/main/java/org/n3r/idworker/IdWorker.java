...
public class IdWorker {
  ...
  public IdWorker(long workerId) {
    ...
    logger.debug(
        "worker starting. timestamp left shift {}, worker id {}", timestampLeftShift, workerId);
  }
  ...
  private long checkWorkerId(long workerId) {
    ...
    if (workerId > maxWorkerId || workerId < 0) {
      ...
      logger.warn(
          "worker Id can't be greater than {} or less than 0, use a random {}", maxWorkerId, rand);
      return rand;
    }
